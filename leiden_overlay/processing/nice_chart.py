...
opacity = 0.8
rect_unknown = ax.bar(x_axis, threshold_unknown, color='#add8e6', align='center', alpha=opacity, edgecolor='grey')
rect_no = ax.bar(x_axis, threshold_no, bottom=threshold_unknown, color='y', align='center', alpha=opacity, edgecolor='grey')
rect_yes = ax.bar(x_axis, threshold_yes, bottom=[threshold_no[i] + threshold_unknown[i] for i in range(0, 10)], color='r', align='center', alpha=opacity, edgecolor='grey')
...
fig.savefig("./all_charts/"+ input_gene + "_new_chart.png")
#plt.show()
